...
ServerEvents.recipes(event => {
    ...
    event.recipes.gtceu.kinetic_ore_factory('iron_ore_factory')
        ...
        .chancedOutput('gtceu:vanadium_dust', 1250, 0)
        .duration(320)
        .inputStress(256)
        .rpm(32);

    event.recipes.gtceu.kinetic_ore_factory('cassiterite_ore_factory')
        .itemInputs('gtceu:crushed_cassiterite_ore')
        .inputFluids('minecraft:water 100')
        .itemOutputs('gtceu:cassiterite_dust')
        .chancedOutput('gtceu:cassiterite_dust', 5000, 0)
        .chancedOutput('gtceu:bismuth_dust', 2500, 0)
