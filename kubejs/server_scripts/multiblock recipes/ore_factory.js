...
ServerEvents.recipes(event => {
    ...
    event.recipes.gtceu.electrico_kinetic_ore_factory('iron_e_ore_factory')
        ...
        .chancedOutput('gtceu:vanadium_dust', 3250, 50)
        .duration(160)
        .inputStress(256)
        .rpm(32)
        .EUt(28);
    ...
    event.recipes.gtceu.electrico_kinetic_ore_factory('cassiterite_e_ore_factory')
        .itemInputs('gtceu:crushed_cassiterite_ore')
        .inputFluids('minecraft:water 100')
        .itemOutputs('gtceu:cassiterite_dust')
        .chancedOutput('gtceu:cassiterite_dust', 7500, 50)
        .chancedOutput('gtceu:bismuth_dust', 4500, 100)
