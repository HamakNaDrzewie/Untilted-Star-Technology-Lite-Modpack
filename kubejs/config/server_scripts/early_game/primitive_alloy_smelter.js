...
//         .itemInputs('gtceu:invar_ingot', '2x minecraft:soul_sand', '2x minecraft:coal')
...
//         .itemInputs('gtceu:invar_ingot', '2x minecraft:soul_sand', '2x minecraft:charcoal')
//         .itemOutputs('gtceu:soul_infused_ingot', 'gtceu:small_dark_ash_dust')
//         .duration(300);

//     event.recipes.gtceu.primitive_alloy_smelter('primitive_soul_infused_ingot_coke')
//         .itemInputs('gtceu:invar_ingot', '2x minecraft:soul_sand', 'gtceu:coke_gem')
...
//         .itemInputs('gtceu:invar_dust', '2x minecraft:soul_sand', '2x minecraft:coal')
//         .itemOutputs('gtceu:soul_infused_ingot', 'gtceu:small_dark_ash_dust')
//         .duration(200);

//     event.recipes.gtceu.primitive_alloy_smelter('primitive_soul_infused_dust_charcoal')
//         .itemInputs('gtceu:invar_dust', '2x minecraft:soul_sand', '2x minecraft:charcoal')
//         .itemOutputs('gtceu:soul_infused_ingot', 'gtceu:small_dark_ash_dust')
//         .duration(300);

//     event.recipes.gtceu.primitive_alloy_smelter('primitive_soul_infused_dust_coke')
//         .itemInputs('gtceu:invar_dust', '2x minecraft:soul_sand', 'gtceu:coke_gem')
//         .itemOutputs('gtceu:soul_infused_ingot', '2x gtceu:small_dark_ash_dust')
//         .duration(260);
